...
<head>
    ...
    <title>{{ trans('OnDoc - PDF Export', [], $lang) }}</title>
                                                ...
                                                <tbody>
                                                    <tr style="">
                                                        <td class="body-padding mobile-padding"
                                                            style="width: 433px;">
                                                            <table class="soapbox"
                                                                style="width: 100%;margin-bottom: 30px;" width="100%"
                                                                cellspacing="0" cellpadding="0">
                                                                <tbody>
                                                                    <tr style="height: 10px;">
                                                                        <td class="soapbox-title"
                                                                            style="font-family: 'Poppins', sans-serif;font-style: normal;font-weight: 600;font-size: 15px;line-height: 22px;text-align: center;color: #135F84;margin:0;padding:0;margin: 0px 0px 32px 0px;">
                                                                            {{ trans('Hello', [], $lang) }} {{ $name }}
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                                                    ...
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell"
                                                                                            ...
                                                                                            <p style="font-family: 'Poppins', sans-serif ;font-style: normal;font-weight: 400;font-size: 15px;line-height: 22px;text-align: center;color: #135F84;margin:0;padding:0;padding:0;margin: 0px 0px 32px 0px;">
                                                                                                {{ trans('You have requested a PDF export with the products and the QR code.', [], $lang)}}
                                                                                            </p>
                                                                                            <p style="font-family: 'Poppins', sans-serif ;font-style: normal;font-weight: 400;font-size: 15px;line-height: 22px;text-align: center;color: #135F84;margin:0;padding:0;padding:0;">
                                                                                                {{ trans('Please find attached the PDF.', [], $lang) }}
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
