...
<head>
    ...
    <title>{{ trans('OnDoc Company Admin Access Invitation', [], $lang) }}</title>
                                                ...
                                                <tr>
                                                    <td class="header center" width="100%" style="margin: 0;padding:0;">
                                                        ...
                                                        <h1 class="header-title" style="margin:0;padding:0;font-family: 'Poppins', sans-serif;font-style: normal;font-weight: 600;font-size: 33px;line-height: 36px;color: #1AA1E4;">
                                                            {{ trans('OnDoc Admin Access Invitation', [], $lang) }}
                                                        </h1>
                                                    </td>
                                                </tr>
                                            </tbody>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell"
                                                                                            style="">
                                                                                            <p style="font-family: 'Poppins', sans-serif ;font-style: normal;font-weight: 400;font-size: 15px;line-height: 22px;text-align: center;color: #135F84;margin:0;">
                                                                                               {{ trans('You are invited to access the admin panel of OnDoc for “:name”', ['name'=>$company->name], $lang) }}
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell"
                                                                                            style="">
                                                                                            <p style="font-family: 'Poppins', sans-serif ;font-style: normal;font-weight: 400;font-size: 15px;line-height: 22px;text-align: center;color: #135F84;margin:0;padding:0;margin: 0px 0px 32px 0px;">
                                                                                               {{ trans('Please login with your email and the password below', [], $lang) }}
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr style="">
                                                                                    ...
                                                                                    <tr style="">
                                                                                        <td  style="">
                                                                                            <div align="center">
                                                                                                <a style="width:310px;background-color: #569FE8; border-radius: 32px; color: #ffffff; display: inline-block; font-family: 'Poppins', sans-serif; font-size: 16px; line-height:19.2px; font-weight: 700;text-align: center; text-decoration: none;  -webkit-text-size-adjust: none; mso-hide: all; margin-top: 35px; border: 12px solid #569FE8"
                                                                                                href="{{ route('login') }}" target="_blank" rel="noopener noreferrer">Login</a>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
