...
<head>
    ...
    <title>OnDoc Registrierung</title>
                                                                                    ...
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell"
                                                                                            ...
                                                                                            <p style="font-family: 'Poppins', sans-serif ;font-style: normal;font-weight: 400;font-size: 15px;line-height: 22px;text-align: center;color: #135F84;margin:0;padding:0;">
                                                                                                Damit Du die OnDoc Mobile App nutzen kannst, bitten wir Dich zuerst Deine E-Mail Adresse zu bestätigen indem Du bei der Registrierung den folgenden Verifizierungscode eingibst:
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr style="">
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 100%;">
                                                                            <p style="margin:0;padding:0;font-family: 'Poppins', sans-serif;font-style: normal;font-weight: 400;font-size: 12px;line-height: 18px;text-align: center;color: #787878;">
                                                                                Anschliessend kannst Du Dein persönliches OnDoc Passwort setzen und damit Deine Registrierung abschliessen.
