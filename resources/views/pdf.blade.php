...
<body>
    @foreach($products as $key=>$product)
        ...
        @if($key < count($products) - 1)
            <div style="position:relative; margin-top:60px; page-break-after:always">
        @else
            <div style="position:relative; margin:0 auto; margin-top:60px;">
        @endif
                <div class="row" style="text-align: center; width:100%;margin:0 auto;">
                    <img src="{{ $file_url }}" height="330" width="330">
                </div>
                <div>
                    ...
                    <div class="row" style="margin-top:40px; margin-bottom:40px;">
                        <div style="font-weight:700; font-size:20px; text-align:center">{{ __('Serial Nr.', [], $lang) }}</div>
                        <div style="text-align:center">{{$product->serial_number}}</div>
                    </div>
                    <div class="row" style="margin-top:40px; margin-bottom:40px;">
                        <div style="font-weight:700; font-size:20px; text-align:center">{{ __('Product', [], $lang) }}</div>
