<template>
    <div class="page bg-white p-8 rounded-[8px]">
        <div class="head mb-12">
            ...
            />
            <h1 class="title font-bold text-20 text-[#7059E2]">{{ $t('Edit Supplier') }}</h1>
        </div>
                ...
                <div class="form__section">
                    <div class="wrapper flex gap-[30px]">
                        <div class="input-field flex gap-3 flex-col w-[285px]">
                            ...
                            <p class="p-0 text-[#5D5D60]">{{ supplier.prefix_id }}</p>
                        </div>
...
onMounted(()=> {
    const {name, street, house_number, postal_code, city, country_code, contact_persion_name, contact_persion_email} = props.supplier
    form.name = name;
    form.street = street;
    ...
    form.contact_persion_name = contact_persion_name;
