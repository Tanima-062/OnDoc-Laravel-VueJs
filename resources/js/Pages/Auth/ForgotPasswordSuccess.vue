    ...
    <div class="grid md:grid-cols-2 md:grid-rows-1 grid-cols-1 grid-row-2 w-full bg-primary-1-1 md:bg-transparent">
        ...
        <div class="contnet min-h-screen bg-background rounded-t-[32px] md:rounded-[0px] flex flex-col">
            <div class="card flex flex-col justify-center md:px-[163px] px-4 py-9 items-center">
                ...
                <div class="message">
                    <h1 class="text-base text-20 text-center md:text-left font-bold mb-[34px] leading-6">{{ $t('Congratulations!') }} <br />
                        {{ $t('Password Updated Successfully') }}</h1>
                    <p class="p-0 text-[14px] text-center md:text-left leading-[17px] text-base">{{ $t('Now you can login with your new password') }}</p>
                    <Link
                        class="mt-[33px] mx-auto w-full bg-primary-1-1 h-12 flex items-center justify-center text-18 text-white font-bold rounded-[8px]"
                        :href="route('login')"
        ...
        <div class="image h-full w-full relative items-end justify-end hidden md:flex">
            ...
            >
            <div class="languages flex gap-[27px] z-1 right-[2%]">
